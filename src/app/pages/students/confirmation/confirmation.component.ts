...
export class ConfirmationComponent implements OnInit, OnDestroy {
  ...
  obtenerDetallesHorario() {
    if (this.horarioId) {
      this.cursoService.obtenerHorariosPorId(this.horarioId).subscribe((horario) => (this.horario = horario));
    } else {
  ...
  obtenerDetallesProfesor() {
    if (this.profesorId) {
      this.cursoService.obtenerProfesorPorId(this.profesorId).subscribe((profesor) => (this.profesor = profesor));
    } else {
