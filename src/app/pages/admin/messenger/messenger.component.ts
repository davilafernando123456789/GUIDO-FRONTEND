    ...
    if (this.editingMensaje) {
      this.adminService.guardarMensajeEditado(this.editingMensaje).subscribe(
        () => {
          ...
          swalWithCustomOptions.fire('Éxito', 'El mensaje ha sido actualizado exitosamente.', 'success');
        },
        (error) => {
          console.error('Error al guardar la edición del mensaje:', error);
          swalWithCustomOptions.fire('Error', 'Error al actualizar el mensaje.', 'error');
        }
      );
    }
  }
      ...
      if (result.isConfirmed) {
        this.adminService.eliminarMensaje(id.toString()).subscribe(
          () => {
            ...
            swalWithCustomOptions.fire('Eliminado', 'El mensaje ha sido eliminado exitosamente.', 'success');
          },
          (error) => {
            console.error('Error al eliminar el mensaje:', error);
            swalWithCustomOptions.fire('Error', 'Error al eliminar el mensaje', 'error');
          }
        );
      }
    });
